...
import xyz.didx.gleibnif.didcomm.ServiceEndpointDIDCommService
import xyz.didx.gleibnif.didcomm.ServiceEndpointDIDURL
import xyz.didx.gleibnif.didcomm.ServiceEndpointNodes
import xyz.didx.gleibnif.didcomm.ServiceEndpointURI
import xyz.didx.gleibnif.didcomm.VerificationMethod
import xyz.didx.gleibnif.didcomm.VerificationMethodType
